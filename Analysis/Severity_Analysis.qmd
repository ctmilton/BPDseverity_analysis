...
# Getting cumulative explained variance to determine how many componenents to retain
...
To get a reconstruction error rate below .5, we need at least 5 components. Getting 6 componenets significantly reduces the reconstruction error rate.
...
```{python}
# Evaluating the new variable groups
from sklearn.neighbors import KNeighborsClassifier
knn_classifier = KNeighborsClassifier(n_neighbors=2, algorithm='auto')
